...
export default function CreateRFP() {
  ...
  const {
    ...
    resolver: zodResolver(rfpFormSchema) as unknown as Resolver<RFPFormData>,
    defaultValues: {
  ...
  const nextStep = async () => {
    ...
    const isValid = await trigger(fieldsToValidate as Array<keyof RFPFormData>)
    if (isValid) {
        ...
        return (
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select onValueChange={(value) => setValue("confidentiality", value as RFPFormData["confidentiality"])}>
                <SelectTrigger>
